...
import 'package:communityapp/screens/profile_screen.dart';
import 'package:communityapp/screens/search_screen.dart';
import 'package:communityapp/services/auth_services.dart';
import 'package:communityapp/services/database_services.dart';
import 'package:communityapp/widgets/group_tile.dart';
import 'package:communityapp/widgets/widget.dart';
    ...
    return Container(
      ...
      child: Center(
        child: Column(children: [
          ...
          const Text(
            "You are not involved in any community ,tap on add icon to create one or join other community from search bar",
            textAlign: TextAlign.center,
          ),
        ]),
      ),
